...
COMPILE="gcc -std=gnu89 -DNDEBUG -DENABLE_JNI -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux -m64 -O3 -ffast-math -fweb -fomit-frame-pointer -fmerge-all-constants -fPIC -pipe -s"
...
echo building aestest ...
$COMPILE -DASM_AMD64_C -DUSE_INTEL_AES_IF_PRESENT -o aestest aes_ni.c aeskey.c aestab.c aestest.c aes_x64.o
